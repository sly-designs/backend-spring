...
public class UssdController {
    ...
    @ResponseBody
    public String ussdCallback(@RequestParam(value = "sessionId", required = true) String sessionId,
        ...
        if (state.equals("")) {
            ...
            return "CON Welcome to our booking service.\n" +
                    ...
                    "1. " + serviceService.getServiceById(1L).getName() + "\n" +
                    "2. " + serviceService.getServiceById(2L).getName() + "\n" +
                    "3. " + serviceService.getServiceById(3L).getName();
